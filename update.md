...
- 改进：做一个按钮，可以一键隐藏/打开分析控制台 2026年1月30日 06:45 ✅已完成
- 改进：「坐标轴设置」占比提高，占1/3，且「坐标轴设置」这几个字不纳入滚动条 2026年1月30日 06:45 ✅已完成
- 改进：左侧拖动有一些卡顿，提高流畅性 2026年1月30日 06:45 ✅已完成
- 改进：已选资料系列的部分分层了两行，做成1行就可以了 2026年1月30日 06:45 ✅已完成
- 改进：粘贴数据界面按钮布局问题 2026年1月30日 06:45 ✅已完成

## 功能改进
- bug：重复的图例不要重复显示，而是显示为1个，可以通过这个图例统一隐藏或显示
- 改进：数值可以修改展示方式，比如曲线、柱状图等
- 改进：点击恢复默认按钮，仅修改该项的值并生效，不要修改其他设置
- 优化：需要将两个日期多选，两个日期的曲线在同一张图显示
- 优化：在界面适当增加引导用户使用的提示或说明等
- 改进：增加历史数据保存功能
- 改进：提示卡片修改为点击按钮查看使用说明（另外制作）
